...
class TestMultioutputRFRegressorBasic(unittest.TestCase):
    """Tests for MultioutputRFRegressor (Basic info)"""
    ...
    def setUp(self) -> None:
        ...
        self.model = rf.MultioutputRFRegressor(
...
class TestMultioutputRFRegressorModel(unittest.TestCase):
    """Tests for MultioutputRFRegressor (Model generated)"""
