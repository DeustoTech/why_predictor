...
class TestChainedSVMRegressorBasic(unittest.TestCase):
    """Tests for ChainedSVMRegressor (Basic info)"""
    ...
    def setUp(self):
        ...
        self.model = svm.ChainedSupportVectorRegressor(
...
class TestChainedSVMRegressorModel(unittest.TestCase):
    """Tests for ChainedSVMRegressor (Model generated)"""
    ...
    def test_make_predictions(self):
        ...
        # Evaluate
        assert_frame_equal(dtf, expected_df, check_exact=False, atol=2)
