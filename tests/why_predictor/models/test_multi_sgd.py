...
class TestMultioutputSGDRegressorBasic(unittest.TestCase):
    """Tests for MultioutputSGDRegressor (Basic info)"""
    ...
    def setUp(self):
        ...
        self.model = sgd.MultioutputSGDRegressor(
...
class TestMultioutputSGDRegressorModel(unittest.TestCase):
    """Tests for MultioutputSGDRegressor (Model generated)"""
    ...
    def test_make_predictions(self):
        ...
        # Init
        expected_deltas = {
            "col73": [34350177126941656, 29723567515914040],
            "col74": [29342259592865072, 26193358651245180],
            "col75": [23062812590867032, 27435162312638616],
            "col76": [30683302197199000, 33160011188404880],
            "col77": [42376504356509488, 33014083726497144],
            "col78": [32760208795107576, 38344282607714608],
        }
    ...
    def test_calculate_errors_per_file(self):
        ...
        for col in errors.columns[2:]:
            ...
            for value in errors[col]:
                self.assertGreaterEqual(value, 0.0)
                self.assertGreaterEqual(value, 1000000000)
        self.assertTrue(
            os.path.exists(
                "tests/results/errors/raw/"
                + f"{ErrorType.MAPE2.name}_{SHORT_NAME}_"
