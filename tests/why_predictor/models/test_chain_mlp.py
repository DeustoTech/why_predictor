...
class TestChainedMultiLayerPerceptronRegressorBasic(unittest.TestCase):
    """Tests for ChainedMultiLayerPerceptronRegressor (Basic info)"""
    ...
    def setUp(self):
        ...
        self.model = mlp.ChainedMultiLayerPerceptronRegressor(
...
class TestChainedMultiLayerPerceptronRegressorModel(unittest.TestCase):
    """Tests for ChainedMultiLayerPerceptronRegressor (Model generated)"""
