...
class TestMLPModelGroup(unittest.TestCase):
    ...
    def __validate_fit(self, error_value: float) -> None:
        ...
        self.assertAlmostEqual(error, error_value, places=1)
        self.assertEqual(hyperparameters["activation"], "tanh")
        self.assertIn(
            hyperparameters["hidden_layer_sizes"], [[100], [150], [200]]
        )
