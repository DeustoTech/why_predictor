...
class TestShiftedMultiLayerPerceptronRegressorBasic(unittest.TestCase):
    """Tests for ShiftedMultiLayerPerceptronRegressor (Basic info)"""
    ...
    def setUp(self):
        ...
        self.model = mlp.ShiftedMultiLayerPerceptronRegressor(
...
class TestShiftedMultiLayerPerceptronRegressorModel(unittest.TestCase):
    """Tests for ShiftedMultiLayerPerceptronRegressor (Model generated)"""
