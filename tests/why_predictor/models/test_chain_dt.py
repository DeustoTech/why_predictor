...
class TestChainedDecissionTreeRegressorBasic(unittest.TestCase):
    """Tests for ChainedDecissionTreeRegressor (Basic info)"""
    ...
    def setUp(self):
        ...
        self.model = dt.ChainedDecissionTreeRegressor(
...
class TestChainedDecissionTreeRegressorModel(unittest.TestCase):
    """Tests for ChainedDecissionTreeRegressor (Model generated)"""
